using MusicTools.Infrastructure.Security;
...
public class LastFMService : ILastFMService
{
    ...
    public async Task<List<string>> GenreQuery(Models.Query query)
    {
    ...
    public async Task<Image?> ImageQuery(Models.Query query)
    {
